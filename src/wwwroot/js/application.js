...
$(function () {
    function getRight() {
        if (!$('[data-toggle="popover"]').length)
            return 0;
        var right = $(window).width() - ($('[data-toggle="popover"]').offset().left + $('[data-toggle="popover"]').outerWidth());
        return right;
    }
...
$(function () {
    ...
    if ($toc[0]) {
        ...
        var maybeActivateDocNavigation = function () {
            if ($window.width() > 768) {
        ...
        deactivateDocNavigation = function () {
        ...
        var activateDocNavigation = function () {
            var cache = {};
